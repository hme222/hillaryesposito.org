...
export default function Ecommerce() {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sort) {
      ...
      case "featured":
      default:
        // keep original ordering as "featured"
        break;
    }
 ...
 useEffect(() => {
  ...
  return (
    <main className="case-study ecommerce-cs" aria-label="E-Commerce Platform Case Study">
      {/* a11y helpers */}
      <a href="#ecom-products" className="sr-only-focusable">
        Skip to products
      </a>
      ...
      {/* Controls (styled like your forms/cards) */}
      <section className="feature ecommerce-controls" aria-label="Filters and sorting">
        <div className="ecom-controls-grid">
          ...
          <div className="form-group ecom-field">
            ...
            <select id="ecom-category" value={category} onChange={(e) => setCategory(e.target.value)} className="ecom-select">
              {categories.map((c) => (
      ...
      {/* Products */}
      <section id="ecom-products" aria-label="Product results">
        <h2>Products</h2>
      ...
      {/* Notes (keeps your case-study format) */}
      <section>
